...
print("Random check 1")
local minSize = Vector2.new(1024, 768)
local useMobileSizing = false
print("Random check 2")
...
local Connections = {} -- For storing keybind connections to disconnect when Rayfield is destroyed
...
local function makeDraggable(object, dragObject, enableTaptic, tapticOffset)
	...
	local function connectFunctions()
		if dragBar and enableTaptic then
			table.insert(Connections, dragBar.MouseEnter:Connect(function()
				if not dragging and not Hidden then
					TweenService:Create(dragBarCosmetic, TweenInfo.new(0.25, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {BackgroundTransparency = 0.5, Size = UDim2.new(0, 120, 0, 4)}):Play()
				end
			end))

			table.insert(Connections, dragBar.MouseLeave:Connect(function()
				if not dragging and not Hidden then
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if (Settings.KeySystem) then
		...
		if not Passthrough then
			...
			table.insert(Connections, KeyUI.Main.Input.InputBox.FocusLost:Connect(function()
			...
			table.insert(Connections, KeyMain.Hide.MouseButton1Click:Connect(function()
				fadeOutKeyUI(KeyMain)
				task.wait(0.51)
				Passthrough = true
	...
	TabList.Template.Interact.ZIndex = 1
	TabList.Template.Image.ZIndex = 1
	TabList.Template.Title.ZIndex = 1
	...
	function Window:CreateTab(Name, Image, Ext)
		...
		table.insert(Connections, TabButton.Interact.MouseButton1Click:Connect(function()
		...
		function Tab:CreateColorPicker(ColorPickerSettings) -- by Throit
			...
			table.insert(Connections, ColorPicker.Interact.MouseButton1Down:Connect(function()
				task.spawn(function()
			...
			table.insert(Connections, Main.MouseButton1Down:Connect(function()
				if opened then
					mainDragging = true 
				end
			end))
			table.insert(Connections, Main.MainPoint.MouseButton1Down:Connect(function()
				if opened then
					mainDragging = true 
				end
			end))
			table.insert(Connections, Slider.MouseButton1Down:Connect(function()
				sliderDragging = true 
			end))
			table.insert(Connections, Slider.SliderPoint.MouseButton1Down:Connect(function()
				sliderDragging = true 
			end))
			...
			setDisplay()
			table.insert(Connections, ColorPicker.HexInput.InputBox.FocusLost:Connect(function()
			...
			table.insert(Connections, ColorPicker.RGB.RInput.InputBox.FocusLost:connect(function()
				rgbBoxes(ColorPicker.RGB.RInput.InputBox,"R")
				pcall(function()ColorPickerSettings.Callback(Color3.fromHSV(h,s,v))end)
			end))
			table.insert(Connections, ColorPicker.RGB.GInput.InputBox.FocusLost:connect(function()
				rgbBoxes(ColorPicker.RGB.GInput.InputBox,"G")
				pcall(function()ColorPickerSettings.Callback(Color3.fromHSV(h,s,v))end)
			end))
			table.insert(Connections, ColorPicker.RGB.BInput.InputBox.FocusLost:connect(function()
			...
			ColorPicker.Destroying:Connect(function()
				if colorPickerRenderConnection then
					...
					colorPickerRenderConnection = nil
				end
			...
			table.insert(Connections, ColorPicker.MouseEnter:Connect(function()
				TweenService:Create(ColorPicker, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.ElementBackgroundHover}):Play()
			end))

			table.insert(Connections, ColorPicker.MouseLeave:Connect(function()
				TweenService:Create(ColorPicker, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
			end))
			...
			return ColorPickerSettings, ColorPicker
		end
		...
		function Tab:CreateInput(InputSettings)
			...
			table.insert(Connections, Input.InputFrame.InputBox.FocusLost:Connect(function()
				local Success, Response = pcall(function()
			...
			table.insert(Connections, Input.MouseEnter:Connect(function()
			...
			table.insert(Connections, Input.MouseLeave:Connect(function()
				TweenService:Create(Input, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
			end))

			table.insert(Connections, Input.InputFrame.InputBox:GetPropertyChangedSignal("Text"):Connect(function()
		...
		function Tab:CreateDropdown(DropdownSettings)
			...
			table.insert(Connections, Dropdown.Interact.MouseButton1Click:Connect(function()
			...
			table.insert(Connections, Dropdown.MouseEnter:Connect(function()
			...
			table.insert(Connections, Dropdown.MouseLeave:Connect(function()
			...
			local function SetDropdownOptions()
				for _, Option in ipairs(DropdownSettings.Options) do
					...
					table.insert(Connections, DropdownOption.Interact.MouseButton1Click:Connect(function()
		...
		function Tab:CreateKeybind(KeybindSettings)
			...
			table.insert(Connections, Keybind.KeybindFrame.KeybindBox.Focused:Connect(function()
				CheckingForKey = true
			...
			table.insert(Connections, Keybind.MouseEnter:Connect(function()
			...
			table.insert(Connections, Keybind.MouseLeave:Connect(function()
			...
			return KeybindSettings, Keybind
		end
		...
		function Tab:CreateToggle(ToggleSettings)
			...
			if ToggleSettings.Settings then
				...
				table.insert(Connections, Toggle.Settings.MouseEnter:Connect(function()
					TweenService:Create(Toggle.Settings, TweenInfo.new(0.7, Enum.EasingStyle.Exponential), {ImageTransparency = 0}):Play()
				end))
				...
				table.insert(Connections, NewToggleSettings.TopBar.Hide.MouseEnter:Connect(function()
					TweenService:Create(NewToggleSettings.TopBar.Hide, TweenInfo.new(0.7, Enum.EasingStyle.Exponential), {ImageTransparency = 0}):Play()
				end))

				table.insert(Connections, NewToggleSettings.TopBar.Hide.MouseLeave:Connect(function()
			...
			table.insert(Connections, Toggle.MouseLeave:Connect(function()
				TweenService:Create(Toggle, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
			end))

			table.insert(Connections, Toggle.Interact.MouseButton1Click:Connect(function()
				if ToggleSettings.CurrentValue == true then
		...
		function Tab:CreateSlider(SliderSettings)
			...
			table.insert(Connections, Slider.Main.Interact.InputBegan:Connect(function(Input)
				if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then 
			...
			table.insert(Connections, Slider.Main.Interact.InputEnded:Connect(function(Input) 
				if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then 
			...
			table.insert(Connections, Slider.Main.Interact.MouseButton1Down:Connect(function(X)
	...
	task.wait(0.1)
	TweenService:Create(Main, TweenInfo.new(0.6, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {Size = useMobileSizing and UDim2.new(0, 500, 0, 350) or UDim2.new(0, 500, 0, 475)}):Play()
	TweenService:Create(Main.Shadow.Image, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {ImageTransparency = 0.6}):Play()
...
table.insert(Connections, Topbar.ChangeSize.MouseButton1Click:Connect(function()
	if Debounce then return end
	if Minimised then
		Minimised = false
		Maximise()
...
table.insert(Connections, Main.Search.Input:GetPropertyChangedSignal('Text'):Connect(function()
...
table.insert(Connections, Main.Search.Input.FocusLost:Connect(function(enterPressed)
...
table.insert(Connections, Topbar.Search.MouseButton1Click:Connect(function()
	task.spawn(function()
		if searchOpen then
			closeSearch()
		else
...
table.insert(Connections, Topbar.Hide.MouseButton1Click:Connect(function()
...
if MPrompt then
	table.insert(Connections, MPrompt.Interact.MouseButton1Click:Connect(function()
		if Debounce then return end
		if Hidden then
			Hidden = false
			Unhide()
...
for _, TopbarButton in ipairs(Topbar:GetChildren()) do
	if TopbarButton.ClassName == "ImageButton" and TopbarButton.Name ~= 'Icon' then
		table.insert(Connections, TopbarButton.MouseEnter:Connect(function()
			TweenService:Create(TopbarButton, TweenInfo.new(0.7, Enum.EasingStyle.Exponential), {ImageTransparency = 0}):Play()
		end))

		table.insert(Connections, TopbarButton.MouseLeave:Connect(function()
			TweenService:Create(TopbarButton, TweenInfo.new(0.7, Enum.EasingStyle.Exponential), {ImageTransparency = 0.8}):Play()
		end))
	end
end
...
-- custom templates
do
	-- Custom settings holder UI frame - made by @ragesploit on discord.
	do
		local SettingsHolder = Instance.new("Frame")
		SettingsHolder.Parent = Main
	...
	do
		local SettingsTemplate = Instance.new("Frame")
		SettingsTemplate.Parent = Main.SettingsHolder
		...
		TopBarHideButton.ImageRectOffset = Vector2.new(869, 906)
		TopBarHideButton.ImageRectSize = Vector2.new(48, 48)
		TopBarHideButton.ImageTransparency = 0.8
		TopBarHideButton.ScaleType = Enum.ScaleType.Fit

		-- table.insert(Connections, TopBarHideButton.MouseEnter:Connect(function()
		-- 	TweenService:Create(TopBarHideButton, TweenInfo.new(0.3, Enum.EasingStyle.Exponential), {ImageTransparency = 0}):Play()
		-- end))

		-- table.insert(Connections, TopBarHideButton.MouseLeave:Connect(function()
